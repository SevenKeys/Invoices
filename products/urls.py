...
from .views import ProductList, ProductDetails, AddProduct, UpdateProduct, DeleteProduct
...
urlpatterns = [
    ...
    url(r'^get/(?P<product_id>\d+)/$', ProductDetails.as_view(), name='product_details'),
