...
class Product(models.Model):
    ...
    currency = models.CharField(max_length=25, choices=cur,blank=True,null=True)
    category = models.CharField(max_length=25,choices=categories,default='service')
    stock = models.IntegerField(blank=True,null=True)
    units_of_measure = models.CharField(max_length=25,choices=units,default='unit1')
    # id_code = models.IntegerField()
    tax = models.IntegerField(choices=taxes,default=2)
